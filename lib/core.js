...
var _await2 = require("./util/await");

var _await3 = _interopRequireDefault(_await2);
...
_stats2.default.create = 0;

function Class(arg) {
  if (!(this instanceof Class)) {
    if (_is2.default.fn(arg)) {
      return Class.app.apply(Class, arguments);
    } else if (_is2.default.object(arg)) {
...
Class.config = function () {
  if (arguments.length === 1 && _is2.default.string(arguments[0])) {
    return _config[arguments[0]];
  }
  if (arguments.length === 1 && _is2.default.object(arguments[0])) {
    (0, _extend2.default)(_config, arguments[0]);
  }
  if (arguments.length === 2 && _is2.default.string(arguments[0])) {
