...
function Class(arg) {
  if (!(this instanceof Class)) {
    ...
    } else if (_is.is_object.object(arg)) {
...
Class.config = function () {
  if (arguments.length === 1 && _is.is_string.string(arguments[0])) {
    return _config[arguments[0]];
  }
  if (arguments.length === 1 && _is.is_object.object(arguments[0])) {
    (0, _extend.extendjs)(_config, arguments[0]);
  }
  if (arguments.length === 2 && _is.is_string.string(arguments[0])) {
