...
Class.config = function () {
  if (arguments.length === 1 && (0, _is.is_string)(arguments[0])) {
    return _config[arguments[0]];
  }
  if (arguments.length === 1 && (0, _is.is_object)(arguments[0])) {
    (0, _extend.extendjs)(_config, arguments[0]);
  }
  if (arguments.length === 2 && (0, _is.is_string)(arguments[0])) {
