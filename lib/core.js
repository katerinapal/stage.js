...
import { is_fn, is_object, is_string } from "./util/is";
import { awaitjs as _await } from "./util/await";
var statsBinding = {};
if (typeof DEBUG === 'undefined')
  DEBUG = true;

statsBinding.create = 0;

function Class(arg) {
  if (!(this instanceof Class)) {
    if (is_fn.fn(arg)) {
      return Class.app.apply(Class, arguments);
    } else if (is_object.object(arg)) {
...
Class.config = function() {
  if (arguments.length === 1 && is_string.string(arguments[0])) {
    return _config[arguments[0]];
  }
  if (arguments.length === 1 && is_object.object(arguments[0])) {
    extend.extendjs(_config, arguments[0]);
  }
  if (arguments.length === 2 && is_string.string(arguments[0])) {
...
var exported_Class = Class;
export { exported_Class as Class };