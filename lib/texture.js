...
Texture.prototype.draw = function(context, x1, y1, x2, y2, x3, y3, x4, y4) {
  ...
  if (typeof x3 !== 'undefined') {
    x1 = utilmath_mathjsjs.limit(x1, 0, this._sw), x2 = utilmath_mathjsjs.limit(x2, 0, this._sw - x1);
    y1 = utilmath_mathjsjs.limit(y1, 0, this._sh), y2 = utilmath_mathjsjs.limit(y2, 0, this._sh - y1);
