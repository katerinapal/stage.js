...
Texture.prototype.draw = function (context, x1, y1, x2, y2, x3, y3, x4, y4) {
  ...
  if (image === null || (typeof image === "undefined" ? "undefined" : _typeof(image)) !== 'object') {
    return;
  }
  ...
  if (typeof x3 !== 'undefined') {
    x1 = _math2.default.limit(x1, 0, this._sw), x2 = _math2.default.limit(x2, 0, this._sw - x1);
    y1 = _math2.default.limit(y1, 0, this._sh), y2 = _math2.default.limit(y2, 0, this._sh - y1);
