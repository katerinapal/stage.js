...
core_Classjs.string = function(frames) {
  return new Str().frames(frames);
};

Str._super = core_Classjs;
Str.prototype = utilcreate_createjsjs(Str._super.prototype);
...
Str.prototype.frames = function(frames) {
  ...
  if (typeof frames == 'string') {
    frames = core_Classjs.texture(frames);
...
Str.prototype.value = function(value) {
  ...
  if (value === null) {
    value = '';
  } else if (typeof value !== 'string' && !utilis_isjs.array(value)) {
