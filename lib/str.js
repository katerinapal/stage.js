...
_core2.default.string = function (frames) {
  return new Str().frames(frames);
};

Str._super = _core2.default;
Str.prototype = (0, _create2.default)(Str._super.prototype);
...
Str.prototype.frames = function (frames) {
  ...
  if (typeof frames == 'string') {
    frames = _core2.default.texture(frames);
...
Str.prototype.value = function (value) {
  ...
  if (value === null) {
    value = '';
  } else if (typeof value !== 'string' && !_is2.default.array(value)) {
