...
Root._super = _core2.default;
Root.prototype = (0, _create2.default)(Root._super.prototype);

_core2.default.root = function (request, render) {
...
function Root(request, render) {
  ...
  var loop = function loop(now) {
    ...
    _stats2.default.tick = _stats2.default.node = _stats2.default.draw = 0;
    ...
    _stats2.default.fps = elapsed ? 1000 / elapsed : 0;
  };
...
Root.prototype.viewport = function (width, height, ratio) {
  if (typeof width === 'undefined') {
    return (0, _extend2.default)({}, this._viewport);
  }
  this._viewport = {
    width: width,
    height: height,
  ...
  this.viewbox();
  var data = (0, _extend2.default)({}, this._viewport);
  this.visit({
