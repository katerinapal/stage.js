...
core_Classjs._init(function() {
  this._pin = new Pin(this);
});

core_Classjs.prototype.matrix = function(relative) {
  if (relative === true) {
...
core_Classjs.prototype.pin = function(a, b) {
  if (typeof a === 'object') {
    this._pin.set(a);
    return this;
...
function Pin(owner) {
  ...
  // relative to parent
  this._relativeMatrix = new matrix_Matrixjs();

  // relative to stage
  this._absoluteMatrix = new matrix_Matrixjs();
...
core_Classjs.prototype.scaleTo = function(a, b, c) {
  if (typeof a === 'object')
    c = b, b = a.y, a = a.x;
...
Pin._add_shortcuts(core_Classjs);

export { pin_Pin as Pin };
