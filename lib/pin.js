...
_core2.default._init(function () {
  this._pin = new Pin(this);
});

_core2.default.prototype.matrix = function (relative) {
  if (relative === true) {
...
_core2.default.prototype.pin = function (a, b) {
...
function Pin(owner) {
  ...
  // relative to parent
  this._relativeMatrix = new _matrix2.default();

  // relative to stage
  this._absoluteMatrix = new _matrix2.default();
...
_core2.default.prototype.scaleTo = function (a, b, c) {
...
Pin._add_shortcuts(_core2.default);
