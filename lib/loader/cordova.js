...
_core2.default._supported = function () {
...
window.addEventListener('load', function () {
  ...
  var start = (0, _once2.default)(function (msg) {
    DEBUG && msg && console.log('Started on ' + msg);
    if (_core2.default._supported) {
...
function AppLoader(app, configs) {
  ...
  var root = _core2.default.root(requestAnimationFrame, render);
