...
import { oncejs as utilonce_oncejsjs } from "../util/once";
var FastContext;
var DEBUG;
/**
...
core_Classjs._supported = (function() {
...
window.addEventListener('load', function() {
  ...
  var start = utilonce_oncejsjs(function(msg) {
    DEBUG && msg && console.log('Started on ' + msg);
    if (core_Classjs._supported) {
      core_Classjs.start();
    }
...
function AppLoader(app, configs) {
  ...
  var root = core_Classjs.root(requestAnimationFrame, render);
