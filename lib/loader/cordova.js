...
ClassBinding._supported = function () {
...
window.addEventListener('load', function () {
  ...
  var start = (0, _once.oncejs)(function (msg) {
    DEBUG && msg && console.log('Started on ' + msg);
    if (ClassBinding._supported) {
      ClassBinding.start();
    }
...
function AppLoader(app, configs) {
  ...
  var root = ClassBinding.root(requestAnimationFrame, render);
