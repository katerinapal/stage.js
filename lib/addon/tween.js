...
import { Easing as easing_Easingjs } from "./easing";
import { Class as core_Classjs } from "../core";
import { Pin as pin_Pinjs } from "../pin";

core_Classjs.prototype.tween = function(duration, delay, append) {
...
Tween.prototype.ease = function(easing) {
  this._easing = easing_Easingjs(easing);
  return this;
};
...
pin_Pinjs._add_shortcuts(Tween);
