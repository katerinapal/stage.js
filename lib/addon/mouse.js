...
core_moduleObject._load(function(stage, elem) {
  mouse_subscribe(stage, elem);
});

mouse_CLICK = "click";
mouse_START = "touchstart mousedown";
mouse_MOVE = "touchmove mousemove";
mouse_END = "touchend mouseup";
mouse_CANCEL = "touchcancel mousecancel";

mouse_subscribe = function(stage, elem) {
  if (stage.mouse) {
    return;
  }
...
export { mouse_CLICK, mouse_START, mouse_MOVE, mouse_END, mouse_subscribe };
var exported_Mouse = Mouse;
export { exported_Mouse as Mouse };
