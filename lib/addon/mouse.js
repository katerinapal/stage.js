...
exports.Mouse = exports.mouse_subscribe = exports.mouse_END = exports.mouse_MOVE = exports.mouse_START = exports.mouse_CLICK = undefined;
...
_core.Class._load(function (stage, elem) {
  mouse_subscribe(stage, elem);
});

exports.mouse_CLICK = mouse_CLICK = "click";
exports.mouse_START = mouse_START = "touchstart mousedown";
exports.mouse_MOVE = mouse_MOVE = "touchmove mousemove";
exports.mouse_END = mouse_END = "touchend mouseup";
mouse_CANCEL = "touchcancel mousecancel";

exports.mouse_subscribe = mouse_subscribe = function mouse_subscribe(stage, elem) {
  if (stage.mouse) {
    return;
  }
...
function Mouse(stage, elem) {
  ...
  this.publish = function (type, event, targets) {
    ...
    if (targets) {
      while (targets.length) {
        if (this.visitor.end(targets.shift(), this)) break;
      }targets.length = 0;
    } else {
      this.root.visit(this.visitor, this);
    }
  ...
  this.visitor = {
    reverse: true,
    visible: true,
    start: function start(node, mouse) {
      return !node._flag(mouse.type);
    },
    end: function end(node, mouse) {
...
exports.mouse_START = mouse_START;
exports.mouse_MOVE = mouse_MOVE;
exports.mouse_END = mouse_END;
exports.mouse_subscribe = mouse_subscribe;

var exported_Mouse = Mouse;
exports.Mouse = exported_Mouse;
