...
ClassBinding.anim = function (frames, fps) {
  var anim = new Anim();
...
Anim._super = ClassBinding;
Anim.prototype = (0, _create.createjs)(Anim._super.prototype);
...
function Anim() {
  ...
  this._fps = ClassBinding.Anim.FPS;
...
Anim.prototype.fps = function (fps) {
  ...
  this._fps = fps > 0 ? fps : ClassBinding.Anim.FPS;
  this._ft = 1000 / this._fps;
  return this;
};
...
Anim.prototype.frames = function (frames) {
  this._index = 0;
  this._frames = ClassBinding.texture(frames).array();
  this.touch();
  return this;
};
