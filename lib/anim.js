...
_core.Class.anim = function (frames, fps) {
  var anim = new Anim();
...
function Anim() {
  ...
  this._fps = _core.Class.Anim.FPS;
...
Anim.prototype.fps = function (fps) {
  ...
  this._fps = fps > 0 ? fps : _core.Class.Anim.FPS;
  this._ft = 1000 / this._fps;
  return this;
};
...
Anim.prototype.frames = function (frames) {
  this._index = 0;
  this._frames = _core.Class.texture(frames).array();
  this.touch();
  return this;
};
