...
_core2.default.anim = function (frames, fps) {
  var anim = new Anim();
...
Anim._super = _core2.default;
Anim.prototype = (0, _create2.default)(Anim._super.prototype);
...
function Anim() {
  ...
  this._fps = _core2.default.Anim.FPS;
...
Anim.prototype.fps = function (fps) {
  ...
  this._fps = fps > 0 ? fps : _core2.default.Anim.FPS;
  this._ft = 1000 / this._fps;
  return this;
};
...
Anim.prototype.frames = function (frames) {
  this._index = 0;
  this._frames = _core2.default.texture(frames).array();
  this.touch();
  return this;
};
...
Anim.prototype.gotoFrame = function (frame, resize) {
  this._index = _math2.default.rotate(frame, this._frames.length) | 0;
