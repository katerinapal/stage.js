...
import { mathjs as utilmath_mathjsjs } from "./util/math";
import "./pin";
import "./loop";

core_Classjs.anim = function(frames, fps) {
  var anim = new Anim();
...
Anim._super = core_Classjs;
Anim.prototype = utilcreate_createjsjs(Anim._super.prototype);
...
function Anim() {
  ...
  this._fps = core_Classjs.Anim.FPS;
...
Anim.prototype.fps = function(fps) {
  ...
  this._fps = fps > 0 ? fps : core_Classjs.Anim.FPS;
  this._ft = 1000 / this._fps;
  return this;
};
...
Anim.prototype.frames = function(frames) {
  this._index = 0;
  this._frames = core_Classjs.texture(frames).array();
  this.touch();
  return this;
};
...
Anim.prototype.gotoFrame = function(frame, resize) {
  this._index = utilmath_mathjsjs.rotate(frame, this._frames.length) | 0;
