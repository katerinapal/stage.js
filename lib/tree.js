...
import { is as utilis_isjs } from "./util/is";

var iid = 0;

// TODO: do not clear next/prev/parent on remove

core_Classjs.prototype._label = '';

core_Classjs.prototype._visible = true;

core_Classjs.prototype._parent = null;
core_Classjs.prototype._next = null;
core_Classjs.prototype._prev = null;

core_Classjs.prototype._first = null;
core_Classjs.prototype._last = null;

core_Classjs.prototype._attrs = null;
core_Classjs.prototype._flags = null;

core_Classjs.prototype.toString = function() {
  return '[' + this._label + ']';
};
 ...
 */
core_Classjs.prototype.id = function(id) {
  return this.label(id);
};

core_Classjs.prototype.label = function(label) {
...
core_Classjs.prototype.attr = function(name, value) {
...
core_Classjs.prototype.visible = function(visible) {
...
core_Classjs.prototype.hide = function() {
  return this.visible(false);
};

core_Classjs.prototype.show = function() {
  return this.visible(true);
};

core_Classjs.prototype.parent = function() {
  return this._parent;
};

core_Classjs.prototype.next = function(visible) {
  var next = this._next;
...
core_Classjs.prototype.prev = function(visible) {
  var prev = this._prev;
...
core_Classjs.prototype.first = function(visible) {
...
core_Classjs.prototype.last = function(visible) {
  var prev = this._last;
  while (prev && visible && !prev._visible) {
    prev = prev._prev;
  }
...
core_Classjs.prototype.visit = function(visitor, data) {
...
core_Classjs.prototype.append = function(child, more) {
  if (utilis_isjs.array(child))
...
core_Classjs.prototype.prepend = function(child, more) {
  if (utilis_isjs.array(child))
...
core_Classjs.prototype.appendTo = function(parent) {
  append(parent, this);
  return this;
};

core_Classjs.prototype.prependTo = function(parent) {
  prepend(parent, this);
  return this;
};

core_Classjs.prototype.insertNext = function(sibling, more) {
  if (utilis_isjs.array(sibling))
...
core_Classjs.prototype.insertPrev = function(sibling, more) {
  if (utilis_isjs.array(sibling))
...
core_Classjs.prototype.insertAfter = function(prev) {
  insertAfter(this, prev);
  return this;
};

core_Classjs.prototype.insertBefore = function(next) {
...
core_Classjs.prototype.remove = function(child, more) {
...
core_Classjs.prototype.empty = function() {
...
core_Classjs.prototype.touch = function() {
  this._ts_touch = ++iid;
 ...
 */
core_Classjs.prototype._flag = function(obj, name) {
 ...
 * @private
 */
core_Classjs.prototype.hitTest = function(hit) {
  if (this.attr('spy')) {
    return true;
  }
...
function _ensure(obj) {
  if (obj && obj instanceof core_Classjs) {
    return obj;
  }
...
tree_Class = core_Classjs;
export { tree_Class as Class };
