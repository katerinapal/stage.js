...
_core2.default.prototype._label = '';

_core2.default.prototype._visible = true;

_core2.default.prototype._parent = null;
_core2.default.prototype._next = null;
_core2.default.prototype._prev = null;

_core2.default.prototype._first = null;
_core2.default.prototype._last = null;

_core2.default.prototype._attrs = null;
_core2.default.prototype._flags = null;

_core2.default.prototype.toString = function () {
  return '[' + this._label + ']';
};
 ...
 */
_core2.default.prototype.id = function (id) {
  return this.label(id);
};

_core2.default.prototype.label = function (label) {
...
_core2.default.prototype.attr = function (name, value) {
...
_core2.default.prototype.visible = function (visible) {
...
_core2.default.prototype.parent = function () {
  return this._parent;
};

_core2.default.prototype.next = function (visible) {
  var next = this._next;
...
_core2.default.prototype.prev = function (visible) {
  var prev = this._prev;
...
_core2.default.prototype.first = function (visible) {
...
_core2.default.prototype.last = function (visible) {
  var prev = this._last;
  while (prev && visible && !prev._visible) {
    prev = prev._prev;
  }
...
_core2.default.prototype.visit = function (visitor, data) {
...
_core2.default.prototype.append = function (child, more) {
  if (_is2.default.array(child)) for (var i = 0; i < child.length; i++) {
    append(this, child[i]);
...
_core2.default.prototype.prepend = function (child, more) {
  if (_is2.default.array(child)) for (var i = child.length - 1; i >= 0; i--) {
...
_core2.default.prototype.appendTo = function (parent) {
  append(parent, this);
  return this;
};

_core2.default.prototype.prependTo = function (parent) {
  prepend(parent, this);
  return this;
};

_core2.default.prototype.insertNext = function (sibling, more) {
  if (_is2.default.array(sibling)) for (var i = 0; i < sibling.length; i++) {
...
_core2.default.prototype.insertPrev = function (sibling, more) {
  if (_is2.default.array(sibling)) for (var i = sibling.length - 1; i >= 0; i--) {
...
_core2.default.prototype.insertAfter = function (prev) {
  insertAfter(this, prev);
  return this;
};

_core2.default.prototype.insertBefore = function (next) {
...
_core2.default.prototype.remove = function (child, more) {
  if (typeof child !== 'undefined') {
    if (_is2.default.array(child)) {
...
_core2.default.prototype.empty = function () {
  var child,
      next = this._first;
  while (child = next) {
    next = child._next;
...
_core2.default.prototype.touch = function () {
  this._ts_touch = ++iid;
 ...
 */
_core2.default.prototype._flag = function (obj, name) {
 ...
 * @private
 */
_core2.default.prototype.hitTest = function (hit) {
  if (this.attr('spy')) {
    return true;
  }
...
function _ensure(obj) {
  if (obj && obj instanceof _core2.default) {
    return obj;
  }
