...
function bemario(obj) {
  ...
  expect.expect(obj.width).be(_mario.width);
  expect.expect(obj.height).be(_mario.height);

  expect.expect(obj._sx).be(_mario.x);
  expect.expect(obj._sy).be(_mario.y);
  expect.expect(obj._sw).be(_mario.width);
  expect.expect(obj._sh).be(_mario.height);

  expect.expect(obj._dx).be(0);
  expect.expect(obj._dy).be(0);
  expect.expect(obj._dw).be(_mario.width);
  expect.expect(obj._dh).be(_mario.height);
}
